...
# Load Models
mem_rf_model = joblib.load(os.path.join(base_dir, "Models", "Fylex Memory Model - Random Forest.pkl"))
net_dt_model = joblib.load(os.path.join(base_dir, "Models", "Fylex Network Model - Decision Tree.pkl"))

# Load Network Flow Data
network_flow_path = os.path.join(base_dir, "Network Flow", "NetworkFlow.xlsx")
try:
    network_flow_df_raw = pd.read_excel(network_flow_path)
...
memory_dump_path = os.path.join(base_dir, "Memory Dump", "MemoryDump.xlsx")
try:
    memory_dump_df = pd.read_excel(memory_dump_path)
...
class Ui_MainWindow(object):
    ...
    def run_memory_scan(self):
        ...
        # Run prediction
        memrfPredict = mem_rf_model.predict(sample)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.start_scan_desription.setText(_translate("MainWindow", "Click”Start Detection”to begin the two-phase filess malware detection process"))
